...
class Player2(pygame.sprite.Sprite):
    def __init__(self2,pos):
        super().__init__()
        self2.image2 = pygame.Surface((64,64))
        self2.image2.fill('green')
        self2.rect = self2.image2.get_rect(topleft = pos)
        ...
        image2_to_load = pygame.image2.load('1v1 game v2/sprites/zuko.png')
        self2.image2.blit(image2_to_load,(0,0))
        self2.image2.set_colorkey('red')
    ...
    def get_input(self2):
        ...
        if keys[pygame.K_LEFT]:
            self2.direction.x = -1
            image2_to_load = pygame.image2.load('1v1 game v2/sprites/zuko_frame2.png')
            self2.image2.blit(image2_to_load,(0,0))
